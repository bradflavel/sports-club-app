...
const columnHelper = createColumnHelper<TeamMemberWithDetails>();

export function RosterTable({ members, onRemove, onEdit }: RosterTableProps) {
  const [editTarget, setEditTarget] = useState<TeamMemberWithDetails | null>(null);
  ...
  function openEdit(row: TeamMemberWithDetails) {
    setEditTarget(row);
    setEditData({
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e) =>
                    setEditData((prev) => ({ ...prev, isCaptain: e.target.checked }))
                  }
                  className="h-4 w-4"
                />
