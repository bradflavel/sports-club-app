...
export function getCompletionItems(
  ...
  return [
    ...
    { label: 'Social media (at least one)', completed: !!(org.facebook_url || org.instagram_url || org.youtube_url || org.tiktok_url), editTab: 'contact', category: 'Contact' },
    ...
    { label: 'Affiliation number', completed: !!org.affiliation_number, editTab: 'affiliations', category: 'Affiliations' },
    ...
    { label: 'Bank account name', completed: !!org.bank_account_name, editTab: 'financials', category: 'Financials' },
    ...
    { label: 'Terms & conditions', completed: !!org.terms_conditions_url, editTab: 'legal', category: 'Legal' },
    { label: 'Code of conduct', completed: !!org.code_of_conduct_url, editTab: 'legal', category: 'Legal' },
